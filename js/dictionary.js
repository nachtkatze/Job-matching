languages =
    [
		...
		f2: "Escribir al candidato",
		f3: "Llamar al candidato",
		f4: "Convocar reunión",
		...
		t1: "Selecciona los triggers",
		t2: "Selección de triggers",
		t3: "No hay campos para completar",
		t4: "Trigger:",
		t5: "cuando:",
		t6: "si es:",
		submit: "Guardar",
		...
		provenanceHelp:"Selecciona la fuente de datos de los candidatos. En este demostrador únicamente hay disponible una fuente de candidatos generados aleatoriamente.",
...
                      + "You can then click on each box of the entity to see the companies that correspond to the selected fields in the search. ",
		...
		t1: "Select the triggers",
		t2: "Selection of triggers",
		t3: "No fields to complete",
		t4: "Trigger:",
		t5: "when:",
		t6: "if it is:",
		t7: "",
		...
		provenanceHelp:"Select the data source where the candidates has been extracted. For this demonstrator only randomly generated candidates available.",
